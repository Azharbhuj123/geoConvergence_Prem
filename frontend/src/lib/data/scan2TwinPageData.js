export const scan2TwinPageData = {
  hero: {
    title: "Scan2Twin",
    subtitle: "Scan2Twin is an advanced reality-capture process that converts real-world environments into precise, intelligent digital twins.",
    backgroundImage: {
      _type: "image",
      asset: {
  ...
  events: {
    ...
    description: "We bridge the gap between real-world objects and digital experiences, turning physical assets into intelligent, interactive, and data-driven models.",
  },

  howItWorks: {
    title: "How It Works",
    subtitle: "Scan to Twin is the centerpiece of the entire website. It should have its own dedicated page with a full breakdown of the end-to-end process.",
    cards: [
      {
        title: "Scanning",
        description: "The physical capture process. Field workflows, mobile LiDAR, robotic systems, non-disruptive capture, privacy compliance, and survey-grade accuracy.",
        image: { _type: "image", asset: { _ref: "image-c955cfd6715d317da550e3d38bf9c631911364a5-1440x872-png" } }
      },
      {
        title: "Data Conversion",
        description: "Processing raw scan data into structured outputs. This also includes working with existing client data (CAD, BIM, GIS files).",
        image: { _type: "image", asset: { _ref: "image-c955cfd6715d317da550e3d38bf9c631911364a5-1440x872-png" } }
      },
      {
        title: "The Scan to Twin Mode",
        description: "The full end-to-end journey from raw data to a working digital twin.",
        image: { _type: "image", asset: { _ref: "image-c955cfd6715d317da550e3d38bf9c631911364a5-1440x872-png" } }
      },
    ]
  },
  ...
  useCases: {
    ...
    sectionSubtitle: "Indoor mapping solutions are used in different industries:",
    cards: [
      {
        title: "Shopping Mall",
        image: { _type: "image", asset: { _ref: "image-c955cfd6715d317da550e3d38bf9c631911364a5-1440x872-png" } }
