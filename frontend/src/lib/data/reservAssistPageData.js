export const reservAssistPageData = {
  hero: {
    title: "ReservAssist",
  ...
  firstSolution: {
    ...
    description: "Transform your workflows and unlock unprecedented operational efficiency with ReservAssist. We bridge the gap between physical reality and digital excellence.",
  ...
  howItWorks: {
    ...
    sectionSubtitle: "A seamless process designed to deploy ReservAssist effortlessly.",
    cards: [
      {
