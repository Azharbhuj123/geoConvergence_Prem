export const roomReservPageData = {
  hero: {
    title: "RoomReserv",
    subtitle: "Advanced solutions in RoomReserv to redefine physical and digital transformations.",
    backgroundImage: { _type: "image", asset: { _ref: "image-c955cfd6715d317da550e3d38bf9c631911364a5-1440x872-png" } }
  },
  firstSolution: {
    title: "Discover RoomReserv",
    description: "Transform your workflows and unlock unprecedented operational efficiency with RoomReserv. We bridge the gap between physical reality and digital excellence.",
  ...
  howItWorks: {
    ...
    sectionSubtitle: "A seamless process designed to deploy RoomReserv effortlessly.",
    cards: [
      {
