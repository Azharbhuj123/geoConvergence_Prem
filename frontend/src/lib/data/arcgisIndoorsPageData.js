export const arcgisIndoorsPageData = {
  ...
  servicesDescription: {
    title: "ArcGIS Indoors Services Overview",
    description: "Our ArcGIS Indoors services provide end-to-end capabilities tailored to meet complex operational needs, bridging the gap from scan data to fully operational models with efficiency and precision."
  },
  solutions: [
    {
