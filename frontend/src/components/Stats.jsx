...
function StatCard({ value, suffix, label, icon, darkMode, animate }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`text-sm sm:text-base font-semibold font-Inter uppercase tracking-widest ${
    ...
    },
    {
      ...
      icon: (
        ...
        >
          ...
          <path d="M12 2a10 10 0 0110 10c0 5.52-10 14-10 14S2 17.52 2 12A10 10 0 0112 2z" />
        </svg>
      ),
    },
    {
