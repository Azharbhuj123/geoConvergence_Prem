            ...
            <div className={`rounded-[20px] shadow-2xl p-6 lg:p-12 overflow-hidden ${isDark ? 'bg-slate-900 border border-slate-800' : 'bg-blue-950'}`}>
              ...
              <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    <div className="flex flex-col sm:flex-row gap-5">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          className={`w-full px-5 py-4 rounded-xl outline-none focus:ring-2 focus:ring-blue-500 transition-shadow ${isDark ? 'bg-slate-800 text-white placeholder-slate-500 border border-slate-700' : 'bg-white/10 text-white placeholder-blue-300 border border-blue-800 focus:bg-white/20'
                            }`}
                          required
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className={`w-full px-5 py-4 rounded-xl outline-none focus:ring-2 focus:ring-blue-500 transition-shadow resize-y ${isDark ? 'bg-slate-800 text-white placeholder-slate-500 border border-slate-700' : 'bg-white/10 text-white placeholder-blue-300 border border-blue-800 focus:bg-white/20'
                          }`}
                        required
                      ></textarea>
                    </div>
                ...
                <div className="w-full lg:w-[40%] flex flex-col justify-center">
                  <div className={`p-8 lg:p-10 rounded-2xl h-full flex flex-col justify-between shadow-lg border ${isDark ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-100'
                    }`}>
                    <div>
                      <h3 className={`text-2xl font-bold font-['Titillium_Web'] mb-3 ${isDark ? 'text-white' : 'text-slate-900'
                        }`}>
